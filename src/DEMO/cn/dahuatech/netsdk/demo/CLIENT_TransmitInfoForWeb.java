...
import cn.dahuatech.netsdk.DHNetSDKLib;
...
public class CLIENT_TransmitInfoForWeb {
	...
	public static void main(String[] args) {
		...
		if (0 != m_lNativeLoginID.longValue())
		{
			...
			int waittime = 5000;
			boolean bRet = DHNetSDKLibObj.CLIENT_TransmitInfoForWeb(m_lNativeLoginID, szInBuffer, dwInBufferSize, szOutBuffer, dwOutBufferSize, pReserved, waittime);
			if(false == bRet)
			{
				System.out.printf("CLIENT_TransmitInfoForWeb return failure, CLIENT_GetLastError is 0x%x !\n", DHNetSDKLibObj.CLIENT_GetLastError());
			}
			else
			{
